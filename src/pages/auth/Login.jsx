...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen w-full fixed inset-0 overflow-hidden" style={{
      ...
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative h-full w-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md transform scale-100 sm:scale-105">
          ...
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-white mb-3 drop-shadow-2xl">Welcome Back</h2>
            <p className="text-lg text-white/90 drop-shadow-lg">Log in to your OnboardPro account</p>
          </div>
