      ...
      <div className="relative h-full w-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md transform scale-100 sm:scale-105">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-white mb-3 drop-shadow-2xl">Reset Password</h2>
            <p className="text-lg text-white/90 drop-shadow-lg">Enter OTP and new password</p>
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      } rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white shadow-sm text-center text-2xl tracking-widest font-mono`}
                      placeholder="123456"
                    />
                  </div>
                  {errors.otp && (
